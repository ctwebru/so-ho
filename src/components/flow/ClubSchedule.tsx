        ...
        <div className="md:col-span-7">
          ...
          <div className="mt-4 rounded-2xl border-2 border-accent/30 bg-accent/5 p-4 max-w-2xl">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Без карты: занятие из расписания — 200 ₽, оплачивается отдельно от
              дневного клуба. Спецсобытия с ведущим — 500 ₽. На регулярное
              расписание запись не нужна, на спецсобытия — записывайся по клику
              на карточку.
            </p>
          </div>
