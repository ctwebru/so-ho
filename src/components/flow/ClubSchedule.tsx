        ...
        <div className="md:col-span-7">
          ...
          <div className="mt-4 rounded-2xl border-2 border-accent/30 bg-accent/5 p-4 max-w-2xl">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Без карты: дневной клуб (08:00–17:00) — 150 ₽, вечернее занятие из
              расписания — 200 ₽ и оплачивается отдельно. Пришёл только вечером —
              платишь 200 ₽, дневные 150 ₽ не нужны. Спецсобытия с ведущим — 500 ₽.
