...
const answers = [
  {
    ...
    a: "Заходите за спешелти-кофе, десертами и кофе с собой. Без предварительной записи и покупки входа.",
  },
  {
    icon: Laptop,
    q: "Поработать пару часов",
    a: "В том же пространстве — коворкинг: столы, розетки, тишина и две skype-комнаты. Платите за время: от пары часов до постоянного места.",
  },
  {
    icon: Users,
    q: "Провести вечер не дома",
    a: "Вечером то же пространство становится соседским клубом: настолки, PS5, мастер-классы, мягкий фитнес. Можно прийти одному — тут знакомятся.",
  },
];
      ...
      <div className="container mx-auto px-6 py-16 md:py-24">
        <div className="max-w-3xl">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-semibold leading-tight text-balance">
            SO-HO! — это пространство, где можно выпить кофе, поработать и провести вечер
          </h2>
          <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
            120 м² в жилом квартале Flora&amp;Fauna. Днём — кофе и работа,
            вечером — занятия и игры для соседей. Заходить можно без записи и предварительных заказов, членство оформляется на месте.
          </p>
        </div>
